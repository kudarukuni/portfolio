      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            I’m fortunate to have a full-time <span>role as a Senior Technician working on a small Audio and</span> Visual Solutions Startup known as <a href="https://www.netcast.co.zw" target="_blank" rel="noreferrer">Netcast Systems</a>.</font>
            <br />
            <br />
